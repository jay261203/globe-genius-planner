      ...
      <div className="hidden lg:flex lg:flex-1 bg-muted items-center justify-center p-12">
        <div className="max-w-md space-y-6 text-center">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Let AI craft personalized itineraries based on your preferences, budget, and travel style. 
            Join thousands of travelers who've discovered their perfect trips with Trippy.
          </p>
